...
register_coco_instances("fsc_test_val", {}, f"{project_root}/data/fscd_lvis/instances_test_val.json",
                        f"{project_root}/data/fscd_lvis/images")
...
if opts.arch == 'vith':
    ...
    all_predictions = torch.load(f'{project_root}/data/fscd_lvis/sam/all_predictions_vith.pth', map_location='cpu')
else:
    raise NotImplementedError

# load text prompts and pseudo labels
clip_text_prompts = torch.load(f'{project_root}/data/fscd_lvis/clip_text_prompt.pth', map_location='cpu')
# all_pseudo_boxes = torch.load(f'{project_root}/data/fscd_lvis/sam/pseudo_boxes_data_vith.pth', map_location='cpu')
...
def evaluate(split, results, threshold=None):
    ...
    coco_evaluator = COCOEvaluator(dataset_name=f'fsc_test_val', tasks=['bbox', ],
                                   output_dir=f'{project_root}/data/fscd_lvis/temp', max_dets_per_image=1000)
